...
CONCRETELY: Proactively use tavily_search to research the product, its market, \
...
- When you decide you have enough context, write the script following guidelines below.
